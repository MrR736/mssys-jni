...
public class PartitionInfo extends MsSys {
	/* Writes the number of heads to a partition, if iHeads == -1 an attempt is made
	   to find out the correct value, returns true on success, otherwise false */
	...
	public native int write_partition_start_sector_number(PartitionInfo fp,String szPath);
