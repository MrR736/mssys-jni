...
public class Identify extends MsSys {
	...
	public native long partitionStartSector(Identify fp, String szPath);
	...
	/* Returns true if writing a boot record of type iBr seems like a good idea,
	   otherwise false */
	public native int sanity_check(MsSys fp, String szPath, int iBr, int bPrintMessages);
	...
	public native int smart_select(Identify fp, String szPath);
}
